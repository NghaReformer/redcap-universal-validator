# Historical changelog and development notes

This archive preserves the detailed changelog as it stood before release-history reconciliation on 2026-09-18. The former `1.11.0`, `2.0.0`, and `Unreleased` headings were development milestones, not separately published Git tags. Their changes are consolidated into `2.1.0-rc.1`. Version headings in this archive are not evidence of a published release.

See [CHANGELOG.md](CHANGELOG.md) for the current release notes, upgrade requirements, and verification status. Historical claims below describe the state at the time they were written.
